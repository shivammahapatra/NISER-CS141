...
// Declaring a point using default class constructor (x = y = 0):
  Point p1;
  std::cout<< "The x value for p1 is " << p1.Get_X() << "\n";
  std::cout<< "The y value for p1 is " << p1.Get_Y() << "\n";

// Declaring a point with coordinates X = 2, Y = 3:
  Point p2(2, 3);
  std::cout<< "The x value for p2 is " << p2.Get_X() << "\n";
  std::cout<< "The y value for p2 is " << p2.Get_Y() << "\n";
